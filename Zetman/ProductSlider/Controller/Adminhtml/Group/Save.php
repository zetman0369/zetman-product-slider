...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Zetman\ProductSlider\Model\Group')->load($id);
            if (!$model->getId() && $id) {
            ...
            $this->dataPersistor->set('group_products_slider', $data);
    ...
    {
        return $this->_authorization->isAllowed('Zetman_ProductSlider::group_update') || $this->_authorization->isAllowed('Zetman_ProductSlider::group_create');
    }
}
